<div class="container">
    <div class="row mt-4">
        <div class="col">
            ...
            <div id="carouselControls" class="carousel slide carousel-fade my-3" data-bs-ride="carousel" style="background-color:black;">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="8000">
                        <img src="Assets/img/29019_brest.jpg" class="d-block w-100" alt="apprenant">
                    </div>
                    <div class="carousel-item" data-bs-interval="8000">
                        <img src="Assets/img/panoramic-Bretagne_RB_0077640_port_brest-1920x1080.jpg" class="d-block w-100" alt="Apprenant">
                    </div>
                </div>
