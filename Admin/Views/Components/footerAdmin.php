<!-- <div id="footer">              ======================================================
  <div class="bg-dark footer-dark">   Mieux que ça à foutre que de m'emmerder avec un
    <div class="container">           footer de mort
      <div class="row">             ======================================================
        <hr>
        <br>
        <div class="col ">
          <ul class="list-inline text-center">
            <li class="list-inline-item">
              <span style="color:aliceblue;">Iligi</span>
            </li>
            <li class="list-inline-item">
              <span style="color:aliceblue;">|</span>
            </li>
            <li class="list-inline-item"><svg style="color:aliceblue" class="bi bi-bootstrap bg-dark " width="1.5em" height="1.5em" viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
